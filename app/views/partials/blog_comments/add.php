        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Blog Comments</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form id="blog_comments-add-form" role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation"  novalidate action="<?php print_link("blog_comments/add") ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="blog_id">Blog Id <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input  id="blog_id" value="<?php  echo $this->set_field_value('blog_id',''); ?>" type="number" placeholder="Enter Blog Id" step="1"  required="" name="blog_id" class="form-control " />
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input  id="website" value="<?php  echo $this->set_field_value('website',''); ?>" type="text" placeholder="Enter Website"  required="" name="website" class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <textarea placeholder="Enter Comment" required="" rows="" name="comment" class=" form-control"><?php  echo $this->set_field_value('comment',''); ?></textarea>
