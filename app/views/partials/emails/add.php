        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Emails</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form id="emails-add-form" role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation"  novalidate action="<?php print_link("emails/add") ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input  id="subject" value="<?php  echo $this->set_field_value('subject',''); ?>" type="text" placeholder="Enter Subject"  required="" name="subject" class="form-control " />
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input  id="email_id" value="<?php  echo $this->set_field_value('email_id',''); ?>" type="email" placeholder="Enter Email Id"  required="" name="email_id" class="form-control " />
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input  id="status" value="<?php  echo $this->set_field_value('status',''); ?>" type="number" placeholder="Enter Status" step="1"  required="" name="status" class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input  id="deleted_userid" value="<?php  echo $this->set_field_value('deleted_userid',''); ?>" type="number" placeholder="Enter Deleted Userid" step="1"  required="" name="deleted_userid" class="form-control " />
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <textarea placeholder="Enter Email Message" required="" rows="" name="email_message" class=" form-control"><?php  echo $this->set_field_value('email_message',''); ?></textarea>
