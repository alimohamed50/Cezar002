        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Edit Profile Data</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" novalidate action="<?php print_link("y_app_gen/edit/$page_id"); ?>" method="post">
                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input  id="y_app_gen_DOB" class="form-control datepicker" required="" value="<?php  echo $data['y_app_gen_DOB']; ?>" type="datetime" name="y_app_gen_DOB" placeholder="Enter Date of birth" data-enable-time="false"   data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  name="z_country_Id_CountryofCitizenship" placeholder="Select a value ..."    class="form-control">
                                                                <option selected><?php echo $data['z_country_Id_CountryofCitizenship']; ?></option>
                                                                
                                                                <?php
                                                                $rec = $data['z_country_Id_CountryofCitizenship'];
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  name="z_country_Id_CountryofResidence" placeholder="Select a value ..."    class="form-control">
                                                                <option selected><?php echo $data['z_country_Id_CountryofResidence']; ?></option>
                                                                
                                                                <?php
                                                                $rec = $data['z_country_Id_CountryofResidence'];
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <textarea placeholder="Enter Any further information?" rows="" name="y_app_gen_further_information" class=" form-control"><?php  echo $data['y_app_gen_further_information']; ?></textarea>
