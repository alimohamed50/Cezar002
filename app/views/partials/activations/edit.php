        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Edit  Activations</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" novalidate action="<?php print_link("activations/edit/$page_id"); ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input  id="code" value="<?php  echo $data['code']; ?>" type="text" placeholder="Enter Code"  required="" name="code" class="form-control " />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input  id="completed" value="<?php  echo $data['completed']; ?>" type="number" placeholder="Enter Completed" step="1"  required="" name="completed" class="form-control " />
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input  id="completed_at" value="<?php  echo $data['completed_at']; ?>" type="text" placeholder="Enter Completed At"  required="" name="completed_at" class="form-control " />
