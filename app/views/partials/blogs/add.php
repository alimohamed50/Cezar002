        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Blogs</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form id="blogs-add-form" role="form" enctype="multipart/form-data" class="form form-horizontal needs-validation"  novalidate action="<?php print_link("blogs/add") ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="blog_category_id">Blog Category Id <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input  id="blog_category_id" value="<?php  echo $this->set_field_value('blog_category_id',''); ?>" type="number" placeholder="Enter Blog Category Id" step="1"  required="" name="blog_category_id" class="form-control " />
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input  id="user_id" value="<?php  echo $this->set_field_value('user_id',''); ?>" type="number" placeholder="Enter User Id" step="1"  required="" name="user_id" class="form-control " />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input  id="title" value="<?php  echo $this->set_field_value('title',''); ?>" type="text" placeholder="Enter Title"  required="" name="title" class="form-control " />
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input  id="slug" value="<?php  echo $this->set_field_value('slug',''); ?>" type="text" placeholder="Enter Slug"  required="" name="slug" class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <textarea placeholder="Enter Content" required="" rows="" name="content" class=" form-control"><?php  echo $this->set_field_value('content',''); ?></textarea>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input  id="views" value="<?php  echo $this->set_field_value('views','0'); ?>" type="number" placeholder="Enter Views" step="1"  required="" name="views" class="form-control " />
