        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Edit  Blogs</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" novalidate action="<?php print_link("blogs/edit/$page_id"); ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input  id="blog_category_id" value="<?php  echo $data['blog_category_id']; ?>" type="number" placeholder="Enter Blog Category Id" step="1"  required="" name="blog_category_id" class="form-control " />
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input  id="slug" value="<?php  echo $data['slug']; ?>" type="text" placeholder="Enter Slug"  required="" name="slug" class="form-control " />
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input  id="views" value="<?php  echo $data['views']; ?>" type="number" placeholder="Enter Views" step="1"  required="" name="views" class="form-control " />
