        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Edit  Users2</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="card animated fadeIn">
                        <form role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" novalidate action="<?php print_link("users2/edit/$page_id"); ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input  id="user_name" value="<?php  echo $data['user_name']; ?>" type="text" placeholder="Enter User Name"  required="" name="user_name" class="form-control " />
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input  id="user_role" value="<?php  echo $data['user_role']; ?>" type="number" placeholder="Enter User Role" step="1"  required="" name="user_role" class="form-control " />
